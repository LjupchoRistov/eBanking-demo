...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    private final com.example.racepulse.service.UserService userService;

    public CustomAuthenticationProvider(com.example.racepulse.service.UserService userService) {
